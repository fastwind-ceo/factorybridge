...
def main() -> None:
    ...
    email = f"smoke.rfq.{uuid4().hex[:8]}@example.com"
    password = "StrongPassword123"
    reg = client.post("/api/v1/auth/register", json={
        "email": email,
        "password": password,
        "company_name": "Smoke RFQ Customer",
    ...
    rfq = client.post("/api/v1/rfqs", json={
        "title": "Smoke CNC bracket",
        "description": "Smoke RFQ for CNC aluminum bracket.",
        "rfq_type": "BY_DRAWING",
        "category": "CNC_PARTS",
        "quantity": 100,
        "unit": "PCS",
    ...
    print("STEP 005 RFQ smoke passed")
